    ...
    return _through2.default.obj(function (file, encoding, callback) {
        ...
        if (file.isBuffer()) {
            ...
            compile(file).then(file => {
                (0, _gulpUtil.log)('Compile', _gulpUtil.colors.blue(file.path), 'after', _gulpUtil.colors.magenta(_utils2.default.formatTimeUnit(Date.now() - startTime))); //打印编译信息
        ...
        (0, _gulpUtil.log)('Compile', _gulpUtil.colors.green('done'));
        callback();
    });
};
